...
fields: [
          ...
          {"field": {"Name": "weekendRate_c"}},
          {"field": {"Name": "holidayRate_c"}},
          {"field": {"Name": "seasonalRates_c"}},
          {"field": {"Name": "status_c"}},
...
pricePerNight: room.baseRate_c,
        ...
        weekendRate: room.weekendRate_c,
        holidayRate: room.holidayRate_c,
        seasonalRates: room.seasonalRates_c,
        baseRate: room.baseRate_c,
...
baseRate_c: roomData.baseRate ? parseFloat(roomData.baseRate) : (roomData.pricePerNight ? parseFloat(roomData.pricePerNight) : null),
        weekendRate_c: roomData.weekendRate ? parseFloat(roomData.weekendRate) : null,
        holidayRate_c: roomData.holidayRate ? parseFloat(roomData.holidayRate) : null,
        seasonalRates_c: roomData.seasonalRates || null,
...
maxOccupancy_c: updatedData.maxOccupancy ? parseInt(updatedData.maxOccupancy) : undefined,
        weekendRate_c: updatedData.weekendRate ? parseFloat(updatedData.weekendRate) : undefined,
        holidayRate_c: updatedData.holidayRate ? parseFloat(updatedData.holidayRate) : undefined,
        seasonalRates_c: updatedData.seasonalRates || undefined,
